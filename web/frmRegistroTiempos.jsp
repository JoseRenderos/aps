...
<html>
    <head>
        ...
        <title>APS-ALSASA REGISTRAR TIEMPO</title>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <br>
                                <center><h4 class="display-6">REGISTRO DE ACTIVIDADES</h4></center>
                                <br>
                                <div class="row" id="regTiempos">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">

                                        <div class="form-group row" align="left">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3" style="margin-top: 8px;">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3" style="margin-top: 8px;" >
                                                <div class="form-group" id="selectActividad">
                                                    <h5><label>Actividad</label></h5>
                                                    <select id="Actividad" name="Actividad" class="form-control" autocomplete="off" style="width: 100%"></select>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3" style="margin-top: 8px;">
                                                <div class="form-group">
                                                    <h5><label>Inicio: </label></h5>
                                                    <input type="datetime-local" name="input" id="txtFechaInicio" class="form form-control" value="" placeholder="Ingrese inicio " />
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3" style="margin-top: 8px;">
                                                <div class="form-group">
                                                    <h5><label>Fin: </label></h5>
                                                    <input type="datetime-local" name="input" id="txtFechaFin" class="form form-control" value="" placeholder="Ingrese fin " />
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 8px;">
                                        <table id="tablaActRegistradas" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                            ...
                                            <tbody id="contenidoTablaActRegistradas">
                                ...
                                <br>
                                <div align="right">
                                    <button type="button" class="btn btn-danger" id="btnBorrarActividad" hidden><img src="img/borrar.png" width="25px" style="padding-bottom: 4px"></button>
                                </div>
                                <br>
                            </div>
                        </div>
        ...
        <script src="plugins/js/jsRegistroTiempo.js" type="text/javascript"></script>
