<%-- 
    Document   : frmAprobacion
    Created on : 10-26-2022, 01:41:11 PM
    Author     : Mario Valdez
--%>
...
<html>
    <head>
        ...
        <title>APS-ALSASA APROBACION</title>
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-dark" id="sidebar-wrapper" id="navbarSupportedContent">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class='list-group-item list-group-item-action list-group-item-dark p-3' href='frmAprobacion.jsp'><img src='img/edition.png' style='height: 20px; width: 20px;'/>&nbsp;&nbsp;<b>Aprobar edición</b></a>
                    <%
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <input type="hidden" id="txtNumOrden">
                                <br>
                                <center><h4 class="display-6">Aprobacion de edición de actividades</h4></center>
                                <br>
        ...
        <script src="plugins/js/jsAprobacion.js" type="text/javascript"></script>
