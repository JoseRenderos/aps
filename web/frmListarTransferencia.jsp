...
<html>
    <head>
        ...
        <title>APS-ALSASA LISTAR TRANSFERENCIAS</title>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <br>
                                <center><h4 class="display-6">TRANSFERENCIAS</h4></center>
                                <br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <table id="tablaTransferencias" class="display" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>DOCNUM</th>
                                    ...
                                    <tbody id="contenidoTablaTransferencias">
        ...
        <!--MODAL DE ORDEN-->
        <div class="modal fade" id="modalTransferencia" tabindex="-1" role="dialog" aria-labelledby="modalTransferenciaLabel" aria-hidden="true" align="center">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
              <div class="modal-content">
                    <div class="modal-header">
                  <h3 class="modal-title" id="modalTransferenciaLabel">DATOS DE TRANSFERENCIA</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btnCerrarTransferencia1">
                ...
                <div class="modal-body">
                    <div class="container-fluid" align="left">
                        ...
                        <center><h5>DATOS DE TRANSFERENCIA</h5></center>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <p>
                                    <h6><b>ID APP: </b><spam id="idApp"></spam></h6>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <p>
                                    <h6><b>NUMERO DE TRANSFERENCIA SAP: </b><spam id="docNum"></spam></h6>
                                </p>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <p>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <p>
                                    <h6><b>BODEGA ORIGEN: </b><spam id="filler"></spam></h6>
                                </p>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <p>
                                    <h6><b>BODEGA DESTINO: </b><spam id="toWhsCode"></spam></h6>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <hr>
                        <div class="row">
                            <table id="tablaLineasTransferencia" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>COD ARTICULO</th>
                                ...
                                <tbody id="contenidoTablaLineasTransferencia">
                        ...
                        <br>
                        <div align='left'>
                            <button type='button' class='btn btn-primary' id='btnImprimir'><img src='img/printer.png' style='height: 20px; width: 20px;'> Imprimir</button>
                        </div>
                        <div align='right'>
                            <button type='button' class='btn btn-success' id='btnCargar'><img src='img/aprobar.png' style='height: 20px; width: 20px;'> Cargar SAP</button>&nbsp;
                            <button type='button' class='btn btn-danger' id='btnCancelar'><img src='img/rechazar.png' style='height: 20px; width: 20px;'> Cancelar</button>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnCerrarTransferencia">Cerrar</button>
                </div>
              </div>
            </div>
        </div>
        ...
        <script src="plugins/js/jsListarTransferencias.js" type="text/javascript"></script>
