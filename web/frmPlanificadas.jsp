...
<html>
    <head>
        ...
        <title>APS-ALSASA PLANIFICADAS</title>
    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-dark" id="sidebar-wrapper" id="navbarSupportedContent">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-dark active p-3" href="frmPlanificadas.jsp"><img src="img/planning.png" style="height: 20px; width: 20px;"/>&nbsp;&nbsp;<b>Planificadas</b></a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <br>
                                <center><h4 class="display-6">Ordenes de fabricación planificadas</h4></center>
                                <br>
                                <!--BOTON DE MODAL DE AGENDA-->
                                <button type="button" id="btnAgendaP" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modalAgendaP" >Agenda</button>
                                <br>
                                <br>
                                <div align="left">
                                    <div class="row">
        ...
        <!--MODAL DE AGENDA -->
        <div class="modal fade" id="modalAgendaP" tabindex="-1" role="dialog" aria-labelledby="modalAgendaPLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="modalAgendaPlLabel">Agenda de ordenes de fabricación planificadas</h3>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btnCerrarAP">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnCerrarAgendaP">Cerrar</button>
                </div>
              </div>
            </div>
        </div>
        ...
        <script src="plugins/js/jsPlanificadas.js" type="text/javascript"></script>
