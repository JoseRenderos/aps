...
<html>
    <head>
        ...
        <title>APS-ALSASA ASIGNAR DEPTO</title>
    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-dark" id="sidebar-wrapper" id="navbarSupportedContent">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-dark active p-3" href="frmDeptoEmp.jsp"><img src="img/empleado.png" style="height: 20px; width: 20px;"/>&nbsp;&nbsp;<b>Asignar departamento</b></a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <br>
                                <center><h4 class="display-6">Asignación de departamento a empleados</h4></center>
                                <br>
                                <div class="row" id="asigDepto" name="reporte">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">

                                        <div class="form-group row" align="left">
                                            <div class="col-xs-4 col-sm-4 col" style="margin-top: 8px;">
                                            ...
                                            <div class="col-xs- col-sm-3 col" style="margin-top: 8px;" >
                                                <div class="form-group" id="selectDepto">
                                                    <h5><label>Departamento:</label></h5>
                                                    <select id="codeDepto" name="codedepto" class="form-control" autocomplete="off" style="width: 100%"></select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-2 col-sm-2 col-form-label" style="padding-bottom: 1.5em;padding-top: 1.5em;">
                                                <button type="button" id="btnAsignar" class="btn btn-primary ">Asignar departamento</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="plugins/js/jsDeptoEmp.js" type="text/javascript"></script>
