...
<html>
    <head>
        ...
        <title>APS-ALSASA ASIG CONTEO</title>
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div align='center'>
                                <br>
                                <center><h4 class="display-6">ASIGNAR ARTICULOS A CONTAR</h4></center>
                                <br>
                            </div>
                        </div>
                    </div>
                    <br>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 space">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="input" id="txtFecha" class="form form-control" value="" placeholder="Ingrese fecha inicio" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 space">
                                ...
                                <div class="form-group" id="codeArticulos1">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 space">
                                <div class="form-group" id="codeBodega1">
                                    <h5><label>BODEGA:</label></h5>
                                    <select id="codeBodega" name="cecos" class="form-control" autocomplete="off" style="width: 100%" placeholder="Seleccione una Bodega"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 space">
                                <button type="button" id="btnAgregarArticulo" class="btn btn-primary btl-lg">Agregar articulo</button>
                            </div>
                        </div>
                        <br>
                        <div  class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                <div align="left">
                                    <button class="btn btn-success" id="btnCargarPlantilla" name="btnCargarPlantilla">Cargar datos</button>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <br>
                        <div align="right">
                            <button type="submit" class="btn btn-lg btn-success" id="btnGuardar"><img src="img/save.png" width="25px" style="padding-bottom: 4px">&nbsp;Guardar</button>
                        </div>
                </div>
            </div>
        </div>
        ...
        <script src="plugins/js/jsAsigConteo.js" type="text/javascript"></script>
