 ...
 */
public class CtrlPlanificadas extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("mostrar")!=null) {
                try {
                    ...
                    Orden.addAll((Collection)dor.mostrarP(idUsuario, idRol));
            ...
            if (request.getParameter("filtrarOrdenes")!=null) {
                 try {
                     ...
                     String CantRjc;
                     ArrayList<OWOR> Orden= new ArrayList<OWOR>();
                     Orden.addAll((Collection)dor.filtrarOrdenesP(request.getParameter("cecos")));
                     ArrayList<APS_OIGE> oige= new ArrayList<APS_OIGE>();
                     oige.addAll((Collection)dAPSO.comprobarEstado());
            ...
            if (request.getParameter("filtrarAgenda")!=null) {
                try {
                    ...
                    arr.addAll((Collection)dor.filtrarOrdenesP(request.getParameter("cecos")));
            ...
            if (request.getParameter("mostrarAgenda")!=null) {
                try {
                    ...
                    int idUsuario=(Integer)s.getAttribute("idUsuario");
                    int idRol=(Integer)s.getAttribute("idRol");
                    arr.addAll((Collection)dor.mostrarP(idUsuario,idRol));
                    String json= new Gson().toJson(arr);
                    out.print(json);
                } catch (Exception e) {
                    request.setAttribute("error", e.getMessage());
            ...
            if (request.getParameter("filtrarAgendaArt")!=null) {
                try {
                    ArrayList<OWOR> arr= new ArrayList<OWOR>();
                    arr.addAll((Collection)dor.filtrarOrdenesPArt(request.getParameter("itemCode")));
                    String json= new Gson().toJson(arr);
                    out.print(json);
                } catch (Exception e) {
                    System.out.println("controlador.CtrlPlanificadas.filtrarAgendaArt(): "+e.getMessage());
                }
            }
            ...
            if (request.getParameter("listarArticulosA")!=null) {
                try {
                    ...
                    System.out.println("controlador.CtrlPlanificadas.listarArticulosA(): " + e.getMessage());
                }
            }
         }
        processRequest(request, response);
