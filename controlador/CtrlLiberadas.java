 ...
 */
public class CtrlLiberadas extends HttpServlet {
    OWOR or;
    APS_OIGE oige;
    APS_OIGE1 oige1;
    APS_OIGE2 oige2;
        ...
        try (PrintWriter out = response.getWriter()) {
               ...
               if (request.getParameter("mostrar")!=null) {
                    try {
                        ...
                        Orden.addAll((Collection)dO.mostrarL(idUsuario, idRol));
               ...
               if (request.getParameter("filtrarOrdenes")!=null) {
                    try {
                        ...
                        String CantRjc;
                        ArrayList<OWOR> Orden= new ArrayList<OWOR>();
                        Orden.addAll((Collection)dO.filtrarOrdenesL(request.getParameter("cecos")));
                        ArrayList<APS_OIGE> oige= new ArrayList<APS_OIGE>();
                        oige.addAll((Collection)dAPSO.comprobarEstadoTabla());
                        DecimalFormat formato = new DecimalFormat("######.###");
                        for (OWOR or : Orden) {
               ...
               if (request.getParameter("mostrarTraslados")!=null) {
                ...
                if (request.getParameter("filtrarAgenda")!=null) {
                    try {
                        ...
                        arr.addAll((Collection)dO.filtrarOrdenesL(request.getParameter("cecos")));
                ...
                if (request.getParameter("mostrarAgenda")!=null) {
                    try {
                        ...
                        int idUsuario=(Integer)s.getAttribute("idUsuario");
                        int idRol=(Integer)s.getAttribute("idRol");
                        arr.addAll((Collection)dO.mostrarL(idUsuario,idRol));
                        String json= new Gson().toJson(arr);
                        out.print(json);
                    } catch (Exception e) {
                        System.out.println(e.getMessage());
                ...
                if (request.getParameter("procesosOrdenAPS")!=null) {
                    try {
                        ArrayList<OWOR> arr= new ArrayList<OWOR>();
                        HttpSession s = request.getSession();
                        arr.addAll((Collection)dOIGE.procesosOrdenAPS());
                        String json= new Gson().toJson(arr);
                        out.print(json);
                    } catch (Exception e) {
                        System.out.println(e.getMessage());
               ...
               if (request.getParameter("mostrarItem")!=null) {
                ...
                if (request.getParameter("comprobarCantEntregada")!=null) {
                    try {
                        //if(request.getParameter("actividad").contains("114MLINEA1") || request.getParameter("itemCode").contains("SMED")){
                            out.print(999999999);
                        /*}else{
    ...
    //                        oige.setCantAsignada(Integer.parseInt(request.getParameter("cantAsignada")));
                ...
                if (request.getParameter("filtrarAgendaArt")!=null) {
                    try {
                        ArrayList<OWOR> arr= new ArrayList<OWOR>();
                        arr.addAll((Collection)dO.filtrarOrdenesLArt(request.getParameter("itemCode")));
                        String json= new Gson().toJson(arr);
                        out.print(json);
                    } catch (Exception e) {
                        System.out.println("controlador.CtrlLiberadas.filtrarAgendaArt(): "+e.getMessage());
                    }
                }
                ...
                if (request.getParameter("listarArticulosA")!=null) {
                    try {
                        ...
                        System.out.println("controlador.CtrlLiberadas.listarArticulosA(): " + e.getMessage());
                    }
                }
